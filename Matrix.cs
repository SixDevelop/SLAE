    ...
    public class Matrix{
        ...
        public double[,] Solution(double[] b) {
            ...
            double[] Y = new double[rowSize];
                ...
                int fsrNum = colSize - _rank;
                if(fsrNum !=0)
                resultSolution = new double[fsrNum,colSize];
                else {
                resultSolution = new double[1,colSize];
                fsrNum = 1;
                }
                
                Random rnd = new Random();
                for(int i = 0; i < fsrNum; i++) {
                    for(int j = colSize - 1; j >_rank - 1; j--) {
                        X[j] = rnd.Next(0,2);
                    }
